...
FMT_DONT_USE_DEFINE_FLAGS += -DUSE_FMT=0
FMT_DO_USE_DEFINE_FLAGS += -DUSE_FMT=1
...
ifdef UBOOTRELEASE
DEFINE_FLAGS += $(FMT_DO_USE_DEFINE_FLAGS)
...
ifeq ($(NAME),m1n1)
DEFINE_FLAGS += $(FMT_DONT_USE_DEFINE_FLAGS)
...
JEV_LIBUNWIND_PATH := $(shell $(JEV_CXX) $(JEV_CXXFLAGS) -print-file-name=libunwind.a)
ifeq ($(JEV_LIBUNWIND_PATH),libunwind.a)
# assume 
JEV_LIBUNWIND_PATH := -libunwind-missing
endif
